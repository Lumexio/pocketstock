<template>
  <v-dialog content-class="elevation-0" v-bind="dialograck" max-width="20rem" persistent>
    <v-card class="cont-card" v-on:keyup.enter="submit()" elevation="1">
      ...
      <v-row>
        <v-col sm="6" md="12" lx="13">
          <v-text-field v-model="nombre_rack" :counter="10" label="Rack" required></v-text-field>
        </v-col>
      </v-row>
      <v-spacer></v-spacer>
      <v-card-actions>
