  ...
  <div class="tabla" id="app">
    <v-row>
      <v-col cols="12" sm="6" md="4">
        <v-text-field v-model="search" label="Buscar usuario" placeholder="Nombre, correo y rol" class="mx-4"
          id="onsearch"></v-text-field>
      </v-col>
    </v-row>
    <v-app id="inspire">
      <v-progress-linear height="6" indeterminate color="cyan" :active="cargando"></v-progress-linear>
      <v-data-table id="tabla" :headers="headers" :items="usersArray" class="elevation-1" :search="search"
        ...
        <template v-slot:top>
          <v-toolbar flat>
            ...
            <v-spacer></v-spacer>
            <v-dialog v-bind="dialog" max-width="500px">
              <v-card>
                <v-card-title>
                ...
                <v-card-text>
                  <v-container>
                    ...
                    <v-row>
                      <v-col cols="12">
                        <v-text-field :append-icon="show3 ? 'mdi-eye' : 'mdi-eye-off'" v-model="editedItem.password"
            ...
            <v-dialog v-bind="dialogDelete" max-width="500px">
              <v-card>
                <v-card-title class="headline">¿Estas seguro de querer eliminarlo?</v-card-title>
