  ...
  <v-dialog content-class="elevation-0" v-bind="parentdialog" max-width="20rem" persistent>
    <v-card v-on:keyup.enter="submit()" class="cont-card" elevation="2">
      ...
      <v-row justify-sm="center">
        <v-col md="10rem">
          <v-text-field v-model="name" :counter="10" label="Nombre estatus" required></v-text-field>
        </v-col>
      </v-row>
      <v-btn class="mr-4" v-shortkey="['enter']" @shortkey="submit" v-on:click="submit" text>
        Guardar
      </v-btn>
