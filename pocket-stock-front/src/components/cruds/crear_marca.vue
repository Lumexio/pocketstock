<template>
  <v-dialog content-class="elevation-0" v-bind="dialogmarca" max-width="40rem" persistent>
    <v-card v-on:keyup.enter="submit()" class="cont-card" elevation="2">
      ...
      <v-card-actions>
        ...
        <v-btn color="yellow darken-2" class="mr-4" v-shortkey="['enter']" @shortkey="submit" @click="submit()"
          outlined>
          Guardar marca
        </v-btn>
      </v-card-actions>
