<template>
  <v-dialog content-class="elevation-0" v-bind="dialogtravesaño" max-width="28rem" persistent>
    <v-card v-on:keyup.enter="submit()" class="cont-card" elevation="2">
      ...
      <v-row>
        <v-col sm="6" md="12" lx="13">
          <v-text-field v-model="nombre_travesano" :counter="10" type="number" label="Travesaño"
